...
class DragControls extends EventDispatcher {
    ...
    public addToObjects: (obj: THREE.Object3D) => void;
    ...
    constructor(
        ...
        let _selected: THREE.Object3D | null = null,
            _hovered: THREE.Object3D | null = null;
        ...
        function addToObjects(obj: THREE.Object3D) {
            scope._objects.push(obj)
        }
        ...
        function onPointerMove(event: PointerEvent) {
            ...
            if (_selected) {
                ...
                scope.dispatchEvent({ event: event, type: "drag", object: _selected });
